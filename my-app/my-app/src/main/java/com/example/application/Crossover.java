public class Crossover
{
    ...
    //Damages + Prices
    private int lowCost[] = {100,50,150,200,50,200,500,200,1000,500,300};
    private int highCost[] = {1200,800,400,3000,1000,2500,4500,3000,4000,8000,4500};
    ...
    //Constructor
    public Crossover(String a, String d, int n)
    {
        agent = a;
        damage = d;
        deductible = n;
    ...
    {
        String info = "Your agent: " + agent + "\nBefore insurance, the price to fix the " + damage + " on your crossover is between $" + lowPrice + " and $" + highPrice + ".\nPrice you pay after insurance: between $" + lowPrice + " and $" + deductible + "\n";
        ...
        {
            info = "Your agent: " + agent + "\nYour crossover is unrepairable. You will get paid your ACV.\n";
        }
        return info;
