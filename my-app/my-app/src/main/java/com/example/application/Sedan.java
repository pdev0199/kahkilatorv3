public class Sedan
{
    ...
    private int highCost[] = {900,800,400,2000,800,1500,4000,2500,3500,8000,3500};
    ...
    //Constructor
    public Sedan(String a, String d, int n)
    {
        agent = a;
        damage = d;
        deductible = n;
    ...
    {
        String info = "Your agent: " + agent + "\nBefore insurance, the price to fix the " + damage + " on your sedan is between $" + lowPrice + " and $" + highPrice + ".\nPrice you pay after insurance: between $" + lowPrice + " and $" + deductible + "\n";
        ...
        {
            info = "Your agent: " + agent + "\nYour sedan is unrepairable. You will get paid your ACV.\n";
        }
        return info;
