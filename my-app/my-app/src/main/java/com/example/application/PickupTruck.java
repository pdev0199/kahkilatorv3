public class PickupTruck 
{
    ...
    //Damages + Price 
    private int lowCost[] = {100,50,150,200,50,200,500,200,1000,500,200};
    private int highCost[] = {1000,1000,500,2500,1000,2000,5000,4000,5000,10000,4000};
    ...
    //Constructor
    public PickupTruck(String a, String d, int n)
    {
        agent = a;
        damage = d;
        deductible = n;
    ...
    public String toString()
    {
        ...
        String info = "Your agent: " + agent + "\nBefore insurance, the price to fix the " + damage + " on your pickup truck is between $" + lowPrice + " and $" + highPrice + ".\nPrice you pay after insurance: between $" + lowPrice + " and $" + deductible + "\n";
        ...
        {
            info = "Your agent: " + agent + "\nYour pickup truck is unrepairable. You will get paid your ACV.\n"; 
        }
        return info;
