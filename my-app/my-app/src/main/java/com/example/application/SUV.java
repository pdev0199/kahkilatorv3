public class SUV
{
    ...
    //Damages + Prices
    private int lowCost[] = {100,75,200,200,50,200,500,200,1000,500,300};
    private int highCost[] = {1200,1200,600,3000,1000,2000,5000,4500,4500,10000,4000};
    ...
    //Constructor
    public SUV(String a, String d, int n)
    {
        agent = a;
        damage = d;
        deductible = n;
    ...
    {
        String info = "Your agent: " + agent + "\nBefore insurance, the price to fix the " + damage + " on your SUV is between $" + lowPrice + " and $" + highPrice + ".\nPrice you pay after insurance: between $" + lowPrice + " and $" + deductible + "\n";
        ...
        {
            info = "Your agent: " + agent + "\nYour SUV is unrepairable. You will get paid your ACV.\n";
        }
        return info;
