public class LuxuryCar 
{
    ...
    //Damages + Prices
    private int lowCost[] = {200,150,300,300,100,400,1500,500,3000,2000,500};
    private int highCost[] = {3000,2000,1200,5000,2500,6000,10000,5000,10000,20000,15000};
    ...
    //Constructor
    public LuxuryCar(String a, String d, int n)
    {
        agent = a;
        damage = d;
        deductible = n;
    ...
    {
        String info = "Your agent: " + agent + "\nBefore insurance, the price to fix the " + damage + " on your luxury car is between $" + lowPrice + " and $" + highPrice + ".\nPrice you pay after insurance: between $" + lowPrice + " and $" + deductible + "\n";
        ...
        {
            info = "Your agent: " + agent + "\nYour luxury car is unrepairable. You will get paid your ACV.\n";
        }
        return info;
